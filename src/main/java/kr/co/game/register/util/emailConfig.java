package kr.co.game.register.util;
...
public class emailConfig {
	...
	private String mailNaverPassword;
    ...
    public JavaMailSender mailSender() {//JAVA MAILSENDER 인터페이스를 구현한 객체를 빈으로 등록하기 위함.
        ...
        mailSender.setUsername(mailNaverId);//네이버 ID를 넣습니다.

        mailSender.setPassword(mailNaverPassword);//네이버 비밀번호를 넣습니다.

        mailSender.setPassword(mailNaverPaswword);//네이버 비밀번호를 넣습니다.
